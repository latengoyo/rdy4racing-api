...
use \Rdy4Racing-API\Models\map\GameTableMap;
...
abstract class BaseGamePeer
{
    ...
    const OM_CLASS = '\\Rdy4Racing-API\\Models\\Game';
    ...
    /** the column name for the game_code field */
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (GamePeer::GAME_ID, GamePeer::GAME_CODE, GamePeer::GAME_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GAME_ID', 'GAME_CODE', 'GAME_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('game_id', 'game_code', 'game_name', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (GamePeer::GAME_ID => 0, GamePeer::GAME_CODE => 1, GamePeer::GAME_NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('GAME_ID' => 0, 'GAME_CODE' => 1, 'GAME_NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('game_id' => 0, 'game_code' => 1, 'game_name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GamePeer::GAME_CODE);
            $criteria->addSelectColumn(GamePeer::GAME_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.game_id');
            $criteria->addSelectColumn($alias . '.game_code');
            $criteria->addSelectColumn($alias . '.game_name');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(GamePeer::GAME_ID) && $criteria->keyContainsValue(GamePeer::GAME_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(GamePeer::GAME_ID);
            $value = $criteria->remove(GamePeer::GAME_ID);
            if ($value) {
                $selectCriteria->add(GamePeer::GAME_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(GamePeer::GAME_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(GamePeer::DATABASE_NAME);
        $criteria->add(GamePeer::GAME_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(GamePeer::DATABASE_NAME);
            $criteria->add(GamePeer::GAME_ID, $pks, Criteria::IN);
