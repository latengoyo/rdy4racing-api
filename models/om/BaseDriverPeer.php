...
abstract class BaseDriverPeer
{
    ...
    const OM_CLASS = 'Rdy4Racing\\Models\\Driver';
    ...
    /** the column name for the driver_mmr_start field */
    const DRIVER_MMR_START = 'driver.driver_mmr_start';

    /** the column name for the driver_rating_start field */
    const DRIVER_RATING_START = 'driver.driver_rating_start';

    /** the column name for the driver_mmr_end field */
    const DRIVER_MMR_END = 'driver.driver_mmr_end';

    /** the column name for the driver_rating_end field */
    const DRIVER_RATING_END = 'driver.driver_rating_end';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Driver objects.
    ...
    {
        $toNames = DriverPeer::getFieldNames($toType);
        $key = isset(DriverPeer::$fieldKeys[$fromType][$name]) ? DriverPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(DriverPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, DriverPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return DriverPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DriverPeer::DRIVER_MMR_END);
            ...
            $criteria->addSelectColumn($alias . '.driver_mmr_end');
            $criteria->addSelectColumn($alias . '.driver_rating_end');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(DriverPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(DriverPeer::DATABASE_NAME);
     ...
     *
     * @param Driver $obj A Driver object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(DriverPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(DriverPeer::$instances[$key])) {
                return DriverPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (DriverPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        DriverPeer::$instances = array();
    }
    ...
    {
        $key = DriverPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = DriverPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + DriverPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = DriverPeer::OM_CLASS;
            $obj = new $cls();
    ...
    /**
     * Selects a collection of Driver objects pre-filled with their Session objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinSession(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Driver) to $obj2 (Session)
                $obj2->addDriver($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Driver) to the collection in $obj2 (Session)
                $obj2->addDriver($obj1);
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptSession(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Driver objects pre-filled with all related objects except Session.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptSession(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    {
        return Propel::getDatabaseMap(DriverPeer::DATABASE_NAME)->getTable(DriverPeer::TABLE_NAME);
    }
    ...
    /**
     * Performs an UPDATE on the database, given a Driver or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(DriverPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(DriverPeer::DRIVER_SESSION_ID);
            $value = $criteria->remove(DriverPeer::DRIVER_SESSION_ID);
            if ($value) {
                $selectCriteria->add(DriverPeer::DRIVER_SESSION_ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the driver table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(DriverPeer::TABLE_NAME, $con, DriverPeer::DATABASE_NAME);
