...
use Rdy4Racing\Models\map\SessionTableMap;
...
abstract class BaseSessionPeer
{
    ...
    const OM_CLASS = 'Rdy4Racing\\Models\\Session';
    ...
    /** the column name for the session_game_id field */
    const SESSION_GAME_ID = 'session.session_game_id';

    /** the column name for the session_stype_id field */
    const SESSION_STYPE_ID = 'session.session_stype_id';

    /** the column name for the session_sstate_id field */
    const SESSION_SSTATE_ID = 'session.session_sstate_id';
    ...
    /**
     * An identity map to hold any loaded instances of Session objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GameId', 'TypeId', 'StateId', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'gameId', 'typeId', 'stateId', 'description', ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::SESSION_ID, SessionPeer::SESSION_GAME_ID, SessionPeer::SESSION_STYPE_ID, SessionPeer::SESSION_SSTATE_ID, SessionPeer::SESSION_DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SESSION_ID', 'SESSION_GAME_ID', 'SESSION_STYPE_ID', 'SESSION_SSTATE_ID', 'SESSION_DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('session_id', 'session_game_id', 'session_stype_id', 'session_sstate_id', 'session_description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'GameId' => 1, 'TypeId' => 2, 'StateId' => 3, 'Description' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'gameId' => 1, 'typeId' => 2, 'stateId' => 3, 'description' => 4, ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::SESSION_ID => 0, SessionPeer::SESSION_GAME_ID => 1, SessionPeer::SESSION_STYPE_ID => 2, SessionPeer::SESSION_SSTATE_ID => 3, SessionPeer::SESSION_DESCRIPTION => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('SESSION_ID' => 0, 'SESSION_GAME_ID' => 1, 'SESSION_STYPE_ID' => 2, 'SESSION_SSTATE_ID' => 3, 'SESSION_DESCRIPTION' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('session_id' => 0, 'session_game_id' => 1, 'session_stype_id' => 2, 'session_sstate_id' => 3, 'session_description' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionPeer::SESSION_GAME_ID);
            $criteria->addSelectColumn(SessionPeer::SESSION_STYPE_ID);
            $criteria->addSelectColumn(SessionPeer::SESSION_SSTATE_ID);
            $criteria->addSelectColumn(SessionPeer::SESSION_DESCRIPTION);
        } else {
            $criteria->addSelectColumn($alias . '.session_id');
            $criteria->addSelectColumn($alias . '.session_game_id');
            $criteria->addSelectColumn($alias . '.session_stype_id');
            $criteria->addSelectColumn($alias . '.session_sstate_id');
    ...
    public static function doCountJoinGame(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(SessionPeer::SESSION_GAME_ID, GamePeer::GAME_ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related SessionState table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinSessionState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(SessionPeer::SESSION_SSTATE_ID, SessionStatePeer::SSTATE_ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related SessionType table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinSessionType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(SessionPeer::SESSION_STYPE_ID, SessionTypePeer::STYPE_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Session objects pre-filled with their Game objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinGame(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Session) to $obj2 (Game)
    ...
    /**
     * Selects a collection of Session objects pre-filled with their SessionState objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Session objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinSessionState(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = SessionStatePeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = SessionStatePeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    SessionStatePeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Session) to $obj2 (SessionState)
                $obj2->addSession($obj1);
    ...
    /**
     * Selects a collection of Session objects pre-filled with their SessionType objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Session objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinSessionType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = SessionTypePeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = SessionTypePeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    SessionTypePeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Session) to $obj2 (SessionType)
                $obj2->addSession($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SessionStatePeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + SessionStatePeer::NUM_HYDRATE_COLUMNS;

        SessionTypePeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + SessionTypePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Session) to the collection in $obj2 (Game)
                $obj2->addSession($obj1);
            } // if joined row not null

            // Add objects for joined SessionState rows

            $key3 = SessionStatePeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = SessionStatePeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    SessionStatePeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Session) to the collection in $obj3 (SessionState)
                $obj3->addSession($obj1);
            } // if joined row not null

            // Add objects for joined SessionType rows

            $key4 = SessionTypePeer::getPrimaryKeyHashFromRow($row, $startcol4);
            if ($key4 !== null) {
                $obj4 = SessionTypePeer::getInstanceFromPool($key4);
                if (!$obj4) {
                    ...
                    SessionTypePeer::addInstanceToPool($obj4, $key4);
                } // if obj4 loaded

                // Add the $obj1 (Session) to the collection in $obj4 (SessionType)
                $obj4->addSession($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptSessionState(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptSessionType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Session objects pre-filled with all related objects except Game.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptGame(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SessionStatePeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + SessionStatePeer::NUM_HYDRATE_COLUMNS;

        SessionTypePeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + SessionTypePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = SessionPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = SessionStatePeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = SessionStatePeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Session) to the collection in $obj2 (SessionState)
                $obj2->addSession($obj1);
                ...
                $key3 = SessionTypePeer::getPrimaryKeyHashFromRow($row, $startcol3);
                if ($key3 !== null) {
                    $obj3 = SessionTypePeer::getInstanceFromPool($key3);
                    if (!$obj3) {
                    ...
                    $obj3 = new $cls();
                    $obj3->hydrate($row, $startcol3);
                    SessionTypePeer::addInstanceToPool($obj3, $key3);
                } // if $obj3 already loaded

                // Add the $obj1 (Session) to the collection in $obj3 (SessionType)
                $obj3->addSession($obj1);
    ...
    /**
     * Selects a collection of Session objects pre-filled with all related objects except SessionState.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptSessionState(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Session objects pre-filled with all related objects except SessionType.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptSessionType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(SessionPeer::SESSION_ID) && $criteria->keyContainsValue(SessionPeer::SESSION_ID) ) {
