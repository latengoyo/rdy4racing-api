...
/**
 * Base class that represents a row from the 'session_state' table.
 *
 *
 *
 * @package    propel.generator..om
 */
abstract class BaseSessionState extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Rdy4Racing\\Models\\SessionStatePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SessionStatePeer
     */
    ...
    /**
     * The value for the sstate_id field.
     * @var        int
     */
    protected $sstate_id;

    /**
     * The value for the sstate_constant field.
     * @var        string
     */
    protected $sstate_constant;

    /**
     * The value for the sstate_name field.
     * @var        string
     */
    protected $sstate_name;

    /**
     * The value for the sstate_description field.
     * @var        string
     */
    protected $sstate_description;
    ...
    /**
     * Get the [sstate_id] column value.
     *
     * @return int
     */
    public function getId()
    {
        ...
        return $this->sstate_id;
    }

    /**
     * Get the [sstate_constant] column value.
     *
     * @return string
     */
    public function getConstant()
    {
        ...
        return $this->sstate_constant;
    }

    /**
     * Get the [sstate_name] column value.
     *
     * @return string
     */
    public function getName()
    {
        ...
        return $this->sstate_name;
    }

    /**
     * Get the [sstate_description] column value.
     *
     * @return string
     */
    public function getDescription()
    {
        ...
        return $this->sstate_description;
    }

    /**
     * Set the value of [sstate_id] column.
     *
     * @param  int $v new value
     * @return SessionState The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->sstate_id !== $v) {
            $this->sstate_id = $v;
            $this->modifiedColumns[] = SessionStatePeer::SSTATE_ID;
        }
    ...
    /**
     * Set the value of [sstate_constant] column.
     *
    ...
    public function setConstant($v)
    {
        ...
        if ($this->sstate_constant !== $v) {
            $this->sstate_constant = $v;
            $this->modifiedColumns[] = SessionStatePeer::SSTATE_CONSTANT;
        }
    ...
    /**
     * Set the value of [sstate_name] column.
     *
     * @param  string $v new value
     * @return SessionState The current object (for fluent API support)
     */
    public function setName($v)
    {
        ...
        if ($this->sstate_name !== $v) {
            $this->sstate_name = $v;
            $this->modifiedColumns[] = SessionStatePeer::SSTATE_NAME;
        }
    ...
    /**
     * Set the value of [sstate_description] column.
     *
     * @param  string $v new value
     * @return SessionState The current object (for fluent API support)
     */
    public function setDescription($v)
    {
        ...
        if ($this->sstate_description !== $v) {
            $this->sstate_description = $v;
            $this->modifiedColumns[] = SessionStatePeer::SSTATE_DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sstate_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->sstate_constant = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->sstate_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->sstate_description = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = SessionStatePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SessionState object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SessionStatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SessionStateQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SessionStatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SessionStatePeer::SSTATE_ID;
        if (null !== $this->sstate_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SessionStatePeer::SSTATE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SessionStatePeer::SSTATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`sstate_id`';
        }
        if ($this->isColumnModified(SessionStatePeer::SSTATE_CONSTANT)) {
            $modifiedColumns[':p' . $index++]  = '`sstate_constant`';
        }
        if ($this->isColumnModified(SessionStatePeer::SSTATE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`sstate_name`';
        }
        if ($this->isColumnModified(SessionStatePeer::SSTATE_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`sstate_description`';
        }

        $sql = sprintf(
            'INSERT INTO `session_state` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`sstate_id`':
                        $stmt->bindValue($identifier, $this->sstate_id, PDO::PARAM_INT);
                        break;
                    case '`sstate_constant`':
                        $stmt->bindValue($identifier, $this->sstate_constant, PDO::PARAM_STR);
                        break;
                    case '`sstate_name`':
                        $stmt->bindValue($identifier, $this->sstate_name, PDO::PARAM_STR);
                        break;
                    case '`sstate_description`':
                        $stmt->bindValue($identifier, $this->sstate_description, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SessionStatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SessionStatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SessionState'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SessionState'][$this->getPrimaryKey()] = true;
        $keys = SessionStatePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionStatePeer::SSTATE_ID)) $criteria->add(SessionStatePeer::SSTATE_ID, $this->sstate_id);
        if ($this->isColumnModified(SessionStatePeer::SSTATE_CONSTANT)) $criteria->add(SessionStatePeer::SSTATE_CONSTANT, $this->sstate_constant);
        if ($this->isColumnModified(SessionStatePeer::SSTATE_NAME)) $criteria->add(SessionStatePeer::SSTATE_NAME, $this->sstate_name);
        if ($this->isColumnModified(SessionStatePeer::SSTATE_DESCRIPTION)) $criteria->add(SessionStatePeer::SSTATE_DESCRIPTION, $this->sstate_description);
    ...
    {
        $criteria = new Criteria(SessionStatePeer::DATABASE_NAME);
        $criteria->add(SessionStatePeer::SSTATE_ID, $this->sstate_id);
    ...
    /**
     * Generic method to set the primary key (sstate_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of SessionState (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SessionState Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SessionStatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SessionStatePeer();
        }
     ...
     * If this SessionState is new, it will return
    ...
    public function setSessions(PropelCollection $sessions, PropelPDO $con = null)
    {
        ...
        foreach ($sessionsToDelete as $sessionRemoved) {
            $sessionRemoved->setSessionState(null);
        }
     ...
     * Otherwise if this SessionState is new, it will return
     * an empty collection; or if this SessionState has previously
     * been saved, it will retrieve related Sessions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SessionState.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->sstate_id = null;
        $this->sstate_constant = null;
        $this->sstate_name = null;
        $this->sstate_description = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(SessionStatePeer::DEFAULT_STRING_FORMAT);
    }
